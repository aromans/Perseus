    ...
    },
    {
      ...
      "TransformationUpdates": {
        ...
        "New Global Variables": {
          "_TIG_IZ_jXpA_envp": "INIT_FUN: '_TIG_IZ_jXpA_envp__INIT'",
          "_TIG_IZ_jXpA_argv": "INIT_FUN: '_TIG_IZ_jXpA_argv__INIT'",
          "_TIG_IZ_jXpA_argc": "INIT_FUN: '_TIG_IZ_jXpA_argc__INIT'"
        }
      }
    },
    {
...
/* BEGIN VARIABLE-DECL _TIG_IZ_jXpA_envp LOC=UNKNOWN VKEY=1466 */
char **_TIG_IZ_jXpA_envp ;
/* END VARIABLE-DECL _TIG_IZ_jXpA_envp LOC=UNKNOWN VKEY=1466 */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_jXpA_envp LOC=UNKNOWN VKEY=1466 */
char **_TIG_IZ_jXpA_envp  ;
/* END VARIABLE-DEF _TIG_IZ_jXpA_envp LOC=UNKNOWN VKEY=1466 */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_jXpA_argv LOC=UNKNOWN VKEY=1464 */
char **_TIG_IZ_jXpA_argv  ;
/* END VARIABLE-DEF _TIG_IZ_jXpA_argv LOC=UNKNOWN VKEY=1464 */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_jXpA_argv LOC=UNKNOWN VKEY=1464 */
char **_TIG_IZ_jXpA_argv ;
/* END VARIABLE-DECL _TIG_IZ_jXpA_argv LOC=UNKNOWN VKEY=1464 */
...
/* BEGIN VARIABLE-DEF _TIG_IZ_jXpA_argc LOC=UNKNOWN VKEY=1462 */
int _TIG_IZ_jXpA_argc  ;
/* END VARIABLE-DEF _TIG_IZ_jXpA_argc LOC=UNKNOWN VKEY=1462 */
...
/* BEGIN VARIABLE-DECL _TIG_IZ_jXpA_argc LOC=UNKNOWN VKEY=1462 */
int _TIG_IZ_jXpA_argc ;
/* END VARIABLE-DECL _TIG_IZ_jXpA_argc LOC=UNKNOWN VKEY=1462 */
...
/* BEGIN FUNCTION-DECL main LOC=UNKNOWN VKEY=1479 */
int main(int _TIG_IZ_jXpA_formal_argc , char **_TIG_IZ_jXpA_formal_argv , char **_TIG_IZ_jXpA_formal_envp ) ;
/* END FUNCTION-DECL main LOC=UNKNOWN VKEY=1479 */
...
{ 
  int tmp ;
  int tmp___0 ;
  unsigned long _TIG_FN_jXpA_1_fibonacci_next ;

  {
  {
  _TIG_FN_jXpA_1_fibonacci_next = 1UL;
  }
  while (1) {
    switch (_TIG_FN_jXpA_1_fibonacci_next) {
    case 1UL: ;
    if (n <= 1) {
      {
      _TIG_FN_jXpA_1_fibonacci_next = 2UL;
      }
    } else {
      {
      _TIG_FN_jXpA_1_fibonacci_next = 0UL;
      }
    }
    break;
    case 3UL: ;
    ...
    break;
    case 0UL: 
#line 8 "perseus_data/source/benign/fibonacci.c"
    tmp = fibonacci(n - 1);
#line 8
    tmp___0 = fibonacci(n - 2);
    {
    _TIG_FN_jXpA_1_fibonacci_next = 3UL;
    }
    break;
    case 2UL: ;
    return (n);
...
/* BEGIN FUNCTION-DEF main LOC=UNKNOWN VKEY=1479 */
int main(int _TIG_IZ_jXpA_formal_argc , char **_TIG_IZ_jXpA_formal_argv , char **_TIG_IZ_jXpA_formal_envp ) 
{ 
  int i ;
  int tmp ;
  unsigned long _TIG_FN_jXpA_1_main_next ;
  ...
  {
  _TIG_IZ_jXpA_argc = 0;
  goto _TIG_IZ_jXpA_argc__INITINLINE__TIG_IZ_jXpA_argc__INIT;
  }
  _TIG_IZ_jXpA_argc__INITINLINE__TIG_IZ_jXpA_argc__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_jXpA_argv = (char **)0;
  goto _TIG_IZ_jXpA_argv__INITINLINE__TIG_IZ_jXpA_argv__INIT;
  }
  _TIG_IZ_jXpA_argv__INITINLINE__TIG_IZ_jXpA_argv__INIT: /* CIL Label */ ;
  }
  {
  {
  _TIG_IZ_jXpA_envp = (char **)0;
  goto _TIG_IZ_jXpA_envp__INITINLINE__TIG_IZ_jXpA_envp__INIT;
  }
  _TIG_IZ_jXpA_envp__INITINLINE__TIG_IZ_jXpA_envp__INIT: /* CIL Label */ ;
  }
  ...
  while (1) {
    __asm__ volatile ("##_ANNOTATION_INITIALREGION_-TIG-IZ-jXpA--0":);
    _TIG_IZ_jXpA_argc = _TIG_IZ_jXpA_formal_argc;
    _TIG_IZ_jXpA_argv = _TIG_IZ_jXpA_formal_argv;
    _TIG_IZ_jXpA_envp = _TIG_IZ_jXpA_formal_envp;
    break;
  }
  {
  _TIG_FN_jXpA_1_main_next = 5UL;
  }
  while (1) {
    switch (_TIG_FN_jXpA_1_main_next) {
    case 3UL: ;
    return (0);
    break;
    case 6UL: 
#line 13
    tmp = fibonacci(i);
#line 13
    printf((char const   */* __restrict  */)"Fib(%d) = %d\n", i, tmp);
#line 12
    i ++;
    {
    _TIG_FN_jXpA_1_main_next = 0UL;
    }
    break;
    case 5UL: 
#line 12
    ...
    if (i < 10) {
      {
      _TIG_FN_jXpA_1_main_next = 6UL;
      }
    } else {
      {
      _TIG_FN_jXpA_1_main_next = 3UL;
      }
    }
    break;
    default: 
...
/* END FUNCTION-DEF main LOC=UNKNOWN VKEY=1479 */
